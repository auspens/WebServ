...
/*   Updated: 2025/06/08 16:40:46 by wouter           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Server::_runEpollLoop() throw(ChildProcessNeededException) {
	...
	while (true) {
		...
		events.reserve(size);  // Do we really want to do this in the loop? Number of reserve calls if you're tranferring a large amount of data might be too much
